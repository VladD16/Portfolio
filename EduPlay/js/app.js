(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".body-tabs__slider--games")) new swiper_core_Swiper(".body-tabs__slider--games", {
            ...
            if (document.querySelector(".body-tabs__slider--sheets")) new swiper_core_Swiper(".body-tabs__slider--sheets", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        da.init();
        window.onload = () => {
            if (document.querySelectorAll(".item-benefits")) {
                const benefitsItems = document.querySelectorAll(".item-benefits");
                benefitsItems.forEach(((item, index) => {
                    item.style.transitionDelay = `${(index + 1) * .4}s`;
                }));
            }
            if (document.querySelectorAll(".list-download__item")) {
                const downloadItems = document.querySelectorAll(".list-download__item");
                downloadItems.forEach(((item, index) => {
                    item.style.transitionDelay = `${(index + 1) * .3}s`;
                }));
            }
            if (document.querySelectorAll(".know__item")) {
                const downloadItems = document.querySelectorAll(".know__item");
                downloadItems.forEach(((item, index) => {
                    item.style.transitionDelay = `${(index + 1) * .2}s`;
                }));
            }
            if (document.querySelector(".pagination-library__item") && document.querySelector(".tabs__title")) {
                const paginationItems = document.querySelectorAll(".pagination-library__item");
                const tabsTitleItems = document.querySelectorAll(".tabs__title");
                tabsTitleItems.forEach(((item, index) => {
